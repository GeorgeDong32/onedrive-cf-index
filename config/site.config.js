...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'GeorgeDong@m365.georgedong.tech',
  ...
  protectedRoutes: ['/Codes', '/Programs', '/Documents', '/Compressed', '/Medias'],
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/GeorgeDong32',
    },
  ],
